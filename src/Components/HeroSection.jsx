  ...
  return (
    <div className=' flex flex-col'>
      ...
      <div className='w-full flex flex-col justify-center items-center '>
        ...
        <div
          className='py-5'>
          <p className='text-xl px-40 text-center animate-fade-in-bottom delay-1000'>
      ...
      <div className=' flex justify-center items-center gap-20 animate-fade-in-bottom delay-1000'>
        <div>
